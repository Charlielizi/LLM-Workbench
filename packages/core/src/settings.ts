...
export function normalizeAppSettings(
  ...
  return {
    ...
    automaticBackup: merged.automaticBackup,
    backupRetentionDays: merged.backupRetentionDays,
    trashRetentionDays: merged.trashRetentionDays,
    trayEnabled: merged.trayEnabled,
    closeBehavior: merged.closeBehavior,
    ...
    updatePolicy: merged.updatePolicy,
